...
% ============================================================
% Refactoring -- Figure varianti C1-C4
% Sostituisce la sezione figure a partire da "RESOLVER C1"
% Richiede \usepackage{float} nel preambolo
% ============================================================

% ---- RESOLVER C1 ----
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC1ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C1Resolver}.}
\label{fig:resolver-c1-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC1ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C1Resolver}.}
\label{fig:resolver-c1-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC1TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C1Resolver}.}
\label{fig:resolver-c1-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC1TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C1Resolver}.}
\label{fig:resolver-c1-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC1Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C1Resolver}.}
\label{fig:resolver-c1-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC1TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C1Resolver}.}
\label{fig:resolver-c1-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC2ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C2Resolver}.}
\label{fig:resolver-c2-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC2ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C2Resolver}.}
\label{fig:resolver-c2-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC2TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C2Resolver}.}
\label{fig:resolver-c2-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC2TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C2Resolver}.}
\label{fig:resolver-c2-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC2Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C2Resolver}.}
\label{fig:resolver-c2-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC2TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C2Resolver}.}
\label{fig:resolver-c2-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC3ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C3Resolver}.}
\label{fig:resolver-c3-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC3ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C3Resolver}.}
\label{fig:resolver-c3-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC3TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C3Resolver}.}
\label{fig:resolver-c3-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC3TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C3Resolver}.}
\label{fig:resolver-c3-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC3Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C3Resolver}.}
\label{fig:resolver-c3-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC3TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C3Resolver}.}
\label{fig:resolver-c3-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC4ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C4Resolver}.}
\label{fig:resolver-c4-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC4ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C4Resolver}.}
\label{fig:resolver-c4-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC4TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C4Resolver}.}
\label{fig:resolver-c4-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/ResolverC4TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C4Resolver}.}
\label{fig:resolver-c4-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC4Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C4Resolver}.}
\label{fig:resolver-c4-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopResolverC4TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C4Resolver}.}
\label{fig:resolver-c4-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C1ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C1Utf8}.}
\label{fig:utf8-c1-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C1ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C1Utf8}.}
\label{fig:utf8-c1-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C1TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C1Utf8}.}
\label{fig:utf8-c1-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C1TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C1Utf8}.}
\label{fig:utf8-c1-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C1Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C1Utf8}.}
\label{fig:utf8-c1-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C1TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C1Utf8}.}
\label{fig:utf8-c1-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C2ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C2Utf8}.}
\label{fig:utf8-c2-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C2ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C2Utf8}.}
\label{fig:utf8-c2-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C2TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C2Utf8}.}
\label{fig:utf8-c2-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C2TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C2Utf8}.}
\label{fig:utf8-c2-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C2Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C2Utf8}.}
\label{fig:utf8-c2-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C2TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C2Utf8}.}
\label{fig:utf8-c2-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C3ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C3Utf8}.}
\label{fig:utf8-c3-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C3ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C3Utf8}.}
\label{fig:utf8-c3-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C3TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C3Utf8}.}
\label{fig:utf8-c3-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C3TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C3Utf8}.}
\label{fig:utf8-c3-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C3Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C3Utf8}.}
\label{fig:utf8-c3-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C3TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C3Utf8}.}
\label{fig:utf8-c3-randoop-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C4ZeroShotTest.png}
\caption{Coverage JaCoCo della suite LLM Zero-Shot su \texttt{C4Utf8}.}
\label{fig:utf8-c4-zeroshot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C4ZeroShotTestPIT.png}
\caption{Report PIT della suite LLM Zero-Shot su \texttt{C4Utf8}.}
\label{fig:utf8-c4-zeroshot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C4TotTest.png}
\caption{Coverage JaCoCo della suite LLM ToT su \texttt{C4Utf8}.}
\label{fig:utf8-c4-tot-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/llm/Utf8C4TotTestPIT.png}
\caption{Report PIT della suite LLM ToT su \texttt{C4Utf8}.}
\label{fig:utf8-c4-tot-pit}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C4Test.png}
\caption{Coverage JaCoCo della suite Randoop su \texttt{C4Utf8}.}
\label{fig:utf8-c4-randoop-jacoco}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{immagini/randoop/RandoopUtf8C4TestPIT.png}
\caption{Report PIT della suite Randoop su \texttt{C4Utf8}.}
\label{fig:utf8-c4-randoop-pit}
\end{figure}

% Tabella Delta Resolver
\begin{table}[H]
\centering
\footnotesize
\begin{tabular}{lcccc}
\toprule
\textbf{Suite} & \textbf{C1} & \textbf{C2} & \textbf{C3} & \textbf{C4} \\
\midrule
LLM Zero-Shot & $\Delta$ (17) & $\Delta$ (20) & $\Delta$ (16) & $\Delta$ (17) \\
LLM ToT       & ---           & ---           & ---           & ---           \\
Randoop        & ---           & ---           & ---           & ---           \\
\bottomrule
\end{tabular}
\caption{Differenze nei test prodotti sulle varianti di \texttt{Resolver} rispetto
a~$C_0$. $\Delta$~=~differenze strutturali nei metodi/asserzioni generati;
---~=~nessuna differenza oltre al rename della classe.
Il numero tra parentesi indica il conteggio dei metodi di test nella suite generata.}
\label{tab:resolver-delta}
\end{table}
...
\textbf{Suite} & \textbf{C1} & \textbf{C2} & \textbf{C3} & \textbf{C4} \\
\midrule
LLM Zero-Shot & $\Delta$ (16) & ---          & ---          & $\Delta$ (14) \\
LLM ToT       & ---           & $\Delta$ (14) & ---          & ---           \\
Randoop        & ---           & ---           & ---          & ---           \\
\bottomrule
\end{tabular}
\caption{Differenze nei test prodotti sulle varianti di \texttt{Utf8} rispetto
a~$C_0$. $\Delta$~=~differenze strutturali nei metodi/asserzioni generati;
---~=~nessuna differenza oltre al rename della classe.}
\label{tab:utf8-delta}
\end{table}