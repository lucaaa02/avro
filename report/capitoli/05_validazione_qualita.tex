...
problema che è stato risolto controllando lo stato interno attraverso la reflection; 
inoltre, ci si è resi conto che un test già esistente nella suite black box
...
La scelta delle operazioni da considerare 
è stata guidata da un criterio di rappresentatività. 
Invece di trattare ogni singolo test automatico come un'operazione indipendente 
,una scelta che avrebbe dato troppo peso a input casuali o anomali 
rispetto ai casi d'uso reali, soprattutto per i test creati da Randoop,
sono state prese come riferimento le categorie della suite di test manuali (BB). 
Queste ultime sono state usate come operazioni rappresentative, 
ciascuna con un peso uniforme pari a $1/N$.
